...
class JuegoBattleshipTest {
    ...
    void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        juego = new LogicaBattleship();

        Field propioField = LogicaBattleship.class.getDeclaredField("tableroPropio");
        propioField.setAccessible(true);
        tableroPropioReal = (Tablero) propioField.get(juego);

        Field enemigoField = LogicaBattleship.class.getDeclaredField("tableroEnemigo");
        ...
        Field disparadasField = LogicaBattleship.class.getDeclaredField("posicionesDisparadas");
